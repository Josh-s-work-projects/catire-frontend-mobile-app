...
export const OrdersAdmin = () => {
  ...
  const cycleStatus = async (id: string, currentStatus: OrderStatusType) => {
    ...
    // Simple ciclo de estados de ejemplo (Ajusta los enum según los que tengas definidos)
    let nextStatus: OrderStatusType = 'PENDING';
    if (currentStatus === 'PENDING') nextStatus = 'PENDING';
    else if (currentStatus === 'PROCESSING') nextStatus = 'PROCESSING';
    else if (currentStatus === 'DELIVERED') nextStatus = 'DELIVERED';
